...
const Mousepad = () => {
    ...
    return(
        ...
        <Container sx={{minWidth: '100%', minHeight:'100vh', backgroundColor: 'rgb(240, 238, 238)'}}>
            <Typography sx={{fontFamily: 'Montserrat', color:'black', fontSize:'30px', fontStyle:'italic', paddingTop:'30px',  textAlign:'center'}}>Podkladki</Typography>
            ...
            <Box sx={{width:{
                ...
                sm:'center',
                xs:'center'
            },alignItems:'center',gap:'20px', flexDirection:{
                xl:'row',
                lg:'row',
                md:'column',
                sm:'column',
                xs:'column'
            } ,backgroundColor:'white', borderRadius:'10px', marginTop:'20px', marginLeft:'30px', paddingTop:'20px', paddingBottom:'20px', display:'flex'}}>
